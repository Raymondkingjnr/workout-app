...
// Query: *[_type == "workout" && _id == $workoutId][0] {   _id,   type,   date,   duration,   exercises[]{    exercise-> {     _id,     name,     description,    },    sets[] {    reps,    weight,    weightUnit,    _type,    _key    },    _type,    _key   }  }
...
export type SingleExeciesQueryResult = {
  _id: string;
  _type: "exercise";
  _createdAt: string;
  _updatedAt: string;
